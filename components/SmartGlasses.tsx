    ...
    <div className="relative flex items-start justify-center perspective-[1000px]">
      ...
      */}
      ...
      <div className="relative group">
        {/* The "Brow" (Top Frame) */}
        <div className="absolute -top-3 left-0 w-full h-8 bg-gradient-to-b from-neutral-800/60 via-neutral-900/40 to-black/30 rounded-t-2xl z-20 shadow-[0_2px_5px_rgba(0,0,0,0.4)] border-t border-neutral-700/30"></div>
        
        {/* The Glass/Lens Container */}
        <div className="relative w-[320px] h-[240px] rounded-b-[45%] rounded-t-sm border-b-[3px] border-l-[2px] border-r-[2px] border-amber-600/40 bg-transparent overflow-hidden transform translate-z-0">
      ...
      <div className="relative w-10 h-8 mt-1 z-10 flex flex-col items-center">
        {/* Top acetate bridge */}
        <div className="w-full h-2 bg-neutral-900/40 absolute top-0"></div>
        {/* Metal nose bridge */}
      ...
      <div className="relative group">
        {/* The "Brow" (Top Frame) */}
        <div className="absolute -top-3 right-0 w-full h-8 bg-gradient-to-b from-neutral-800/60 via-neutral-900/40 to-black/30 rounded-t-2xl z-20 shadow-[0_2px_5px_rgba(0,0,0,0.4)] border-t border-neutral-700/30"></div>
